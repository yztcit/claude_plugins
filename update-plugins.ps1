...
Write-Host "[INFO] Step 1/2: 刷新 lui-tools marketplace..."
try {
...
Write-Host "[INFO] Step 2/2: 更新 dev@lui-tools 插件..."
claude plugin update dev@lui-tools -s project
claude plugin update dev@lui-tools -s user
...
Write-Host "验证: claude plugin list --json | Select-String dev@lui-tools"
